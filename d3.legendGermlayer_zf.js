...
(function() {
d3.legendGermlayer_zf = function(g) {
  g.each(function() {
    ...
    let myMap_1 = new Map()
      myMap_1.set("neuroectoderm", "Zebrafish: ExE embryo")
      myMap_1.set("surface_ectoderm", "Zebrafish: Other")
      myMap_1.set("endoderm", "Zebrafish: Endoderm")
      myMap_1.set("mesoderm", "Zebrafish: Mesoderm")
      myMap_1.set("exe_germ", "Zebrafish: Neuroectoderm")
      myMap_1.set("other", "Zebrafish: Surface ectoderm")
